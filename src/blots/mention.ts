...
export function createMentionBlot(quill: Quill, QuillStatic: typeof Quill) {
  const Embed = QuillStatic.import("blots/embed") as typeof EmbedBlot;
  ...
  class MentionBlot extends Embed {
    ...
    public hoverHandler?: EventListener;
    public clickHandler?: EventListener;
    ...
    buildEvent(name: string, e: Event): MentionEvent {
  ...
  return { MentionBlot, isMentionBlotData, MentionEvent };
}
